...
class HangmanApp:
    ...
    def show_welcome(self):
        self.clear_widgets()
        self.set_background("first.jpg")  # Set your welcome background image here

        winsound.PlaySound("welcome.wav", winsound.SND_ASYNC | winsound.SND_LOOP)

        self.canvas.create_text(300, 120,                                
        ...
        self.canvas.create_window(300, 230, window=start_btn)
    ...
    def show_category(self):
        ...
        self.canvas.create_text(300, 80,
    ...
    def show_game(self):
        ...
        self.word_text = self.canvas.create_text(300, 70,
                                text=self.display_word(),
                                font=("Arial", 24),
                                fill="white")

        self.info_text = self.canvas.create_text(300, 110,
        ...
        for i, letter in enumerate("abcdefghijklmnopqrstuvwxyz"):
            btn = tk.Button(self.root, text=letter.upper(),
                            width=3,
                            bg="#8c7ae6", fg="white",
    ...
    def guess(self, letter):
        ...
        self.canvas.itemconfig(self.word_text, text=self.display_word())
        self.canvas.itemconfig(self.info_text, text=f"Attempts Left: {self.attempts}")
    ...
    def show_result(self, win):
        ...
        if win:
            ...
            winsound.PlaySound("losser.wav", winsound.SND_ASYNC)
        ...
        score_btn = tk.Button(self.root, text="Score",
                              bg="#fbc531",
                              command=self.show_score)

        self.canvas.create_window(300, 220, window=score_btn)

        again_btn = tk.Button(self.root, text="Play Again",
                              bg="green", fg="black",
                              command=self.show_category)

        self.canvas.create_window(300, 270, window=again_btn)


        quit_btn = tk.Button(self.root, text="Quit",
                     bg="red", fg="white",
                     command=self.root.destroy)
        self.canvas.create_window(300, 320, window=quit_btn) # it for quiting the game at result page
    ...
    def show_score(self):
        ...
        self.canvas.create_window(300, 230, window=again_btn)
